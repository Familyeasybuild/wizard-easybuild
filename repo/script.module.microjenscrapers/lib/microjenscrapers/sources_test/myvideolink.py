...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['mvl.688.org', 'dls.myvideolinks.net', 'get.myvideolinks.net', 'go.myvideolinks.net', 'myvideolinks.69.mu', 'sag.myvideolinks.net', 'looka.myvideolinks.net', 'kita.myvideolinks.net']
        self.base_link = 'http://mvl.688.org'
        #self.base_link = 'http://be.myvideolinks.net'
